...
import djed.dcc.maya.shelves.tool_settings
importlib.reload(djed.dcc.maya.shelves.tool_settings)
...
from djed.dcc.maya.shelves.tool_settings import ToolSettingsBase
