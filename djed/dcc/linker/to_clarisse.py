...
def send_to_clarisse(data, port_num=None):
    try:
        ...
        cmd_text += "try:\n"
        cmd_text += "\tfrom djed.dcc.clarisse.plugins.load_asset import LoadAsset\n"
        cmd_text += "\timport importlib;import djed.dcc.clarisse.plugins.load_asset;importlib.reload(djed.dcc.clarisse.plugins.load_asset)\n"
